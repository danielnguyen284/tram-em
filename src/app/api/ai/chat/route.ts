      ...
      messages: [
        {
          ...
          content: [
            ...
            'CHỈ gợi ý sản phẩm khi chủ đề của người dùng TRỰC TIẾP liên quan đến công dụng sản phẩm đó (ví dụ: mất ngủ → sản phẩm hỗ trợ giấc ngủ; lo âu → tinh dầu thư giãn). Tối đa 1 sản phẩm, nêu tên, lý do ngắn và đường dẫn /shop/<slug>. KHÔNG gợi ý sản phẩm khi chủ đề chỉ là trò chuyện thông thường về cảm xúc.',
